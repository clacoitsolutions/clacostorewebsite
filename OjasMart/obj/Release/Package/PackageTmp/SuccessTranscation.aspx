<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuccessTranscation.aspx.cs" Inherits="OjasMart.SuccessTranscation" %>
...
<body class="authentication-bg authentication-bg-pattern">
    <form id="form1" runat="server">
                        ...
                        <div class="card bg-pattern">
                            <div class="card-body p-4">
                                ...
                                <div class="mt-3 text-center">
                                    <img src="../img/successImage.jpg" alt="" style="height: 54px" />
                                    <h3>Success !</h3>
        ...
        <footer class="footer footer-alt">
            2019 - 2020 &copy; Ozas Mart Developed by <a href="#">SigmaIT Software Designers Pvt. Ltd.</a>
        </footer>
