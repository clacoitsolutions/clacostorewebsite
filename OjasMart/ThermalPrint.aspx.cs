...
namespace OjasMart
{
    ...
    public partial class ThermalPrint : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    try
                    {
                        ...
                        iTextSharp.text.Image jpg = iTextSharp.text.Image.GetInstance("http://vivafreshapi.sigmasoftwares.co/img/logo.png");
                        ...
                        tableLayout.AddCell(new PdfPCell(new Phrase(dt.Rows[0]["CompanyName"].ToString(), new Font(Font.GetFamilyIndex("HELVETICA"), 11, 1))) { Border = 0, PaddingBottom = 1, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 5 });
                        tableLayout.AddCell(new PdfPCell(new Phrase(dt.Rows[0]["company_Address"].ToString(), new Font(Font.GetFamilyIndex("HELVETICA"), 9, 0))) { Border = 0, PaddingBottom = 1, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 5 });
                        ...
                        tableLayout.AddCell(new PdfPCell(new Phrase("GSTIN/UIN:" + dt.Rows[0]["GSTINNo"].ToString(), new Font(Font.GetFamilyIndex("HELVETICA"), 9, 0))) { Border = 0, PaddingBottom = 1, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 5 });
                        tableLayout.AddCell(new PdfPCell(new Phrase("Mobile No. " + dt.Rows[0]["CompanyMobileNo"].ToString(), new Font(Font.GetFamilyIndex("HELVETICA"), 9, 0))) { Border = 0, PaddingBottom = 1, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 5 });
                        tableLayout.AddCell(new PdfPCell(new Phrase(dt.Rows[0]["EmailAddress"].ToString(), new Font(Font.GetFamilyIndex("HELVETICA"), 9, 0))) { Border = 0, PaddingBottom = 1, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 5 });
                        ...
                        tableLayout.AddCell(new PdfPCell(new Phrase("Order No:", new Font(Font.GetFamilyIndex("HELVETICA"), 8, 0))) { Border = 0, PaddingBottom = 1, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 3 });
                        ...
                        tableLayout.AddCell(new PdfPCell(new Phrase(dt.Rows[0]["OrderId"].ToString(), new Font(Font.GetFamilyIndex("HELVETICA"), 8, 0))) { Border = 0, PaddingBottom = 1, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 3 });
                        ...
                        tableLayout.AddCell(new PdfPCell(new Phrase(dt.Rows[0]["Name"].ToString() + " - " + dt.Rows[0]["MobileNo"].ToString(), new Font(Font.GetFamilyIndex("HELVETICA"), 8, 0))) { Border = 0, PaddingBottom = 1, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 2 });
                        tableLayout.AddCell(new PdfPCell(new Phrase("Date: " + dt.Rows[0]["OrderDate"].ToString(), new Font(Font.GetFamilyIndex("HELVETICA"), 8, 0))) { Border = 0, PaddingBottom = 1, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 3 });


                        tableLayout.AddCell(new PdfPCell(new Phrase(dt.Rows[0]["Add1"].ToString(), new Font(Font.GetFamilyIndex("HELVETICA"), 8, 0))) { Border = 0, PaddingBottom = 10, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 2 });
                        tableLayout.AddCell(new PdfPCell(new Phrase("Time: " + dt.Rows[0]["OrderTime"].ToString(), new Font(Font.GetFamilyIndex("HELVETICA"), 8, 0))) { Border = 0, PaddingBottom = 10, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 3 });
                        ...
                        for (int k = 0; k < dt.Rows.Count; k++)
                        {
                            ...
                            tableLayout.AddCell(new PdfPCell(new Phrase(dt.Rows[k]["ItemName"].ToString() + ' ' + Convert.ToString(dt.Rows[k]["VarriationName"]), new Font(Font.GetFamilyIndex("HELVETICA"), 8, 0))) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT });
                            ...
                            tableLayout.AddCell(new PdfPCell(new Phrase(dt.Rows[k]["UnitRate"].ToString(), new Font(Font.GetFamilyIndex("HELVETICA"), 8, 0))) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT });
                        ...
                        decimal delivery_charge = 0;
                        decimal.TryParse(Convert.ToString(dt.Rows[0]["DeliveryCharges"].ToString()), out delivery_charge);

                        decimal discount_amt = 0;
                        decimal.TryParse(Convert.ToString(dt.Rows[0]["DiscountAmount"].ToString()), out discount_amt);

                        decimal NetPayable = 0;
                        decimal.TryParse(Convert.ToString(dt.Rows[0]["NetPayable"].ToString()), out NetPayable);
                        ...
                        tableLayout.AddCell(new PdfPCell(new Phrase(" ", new Font(Font.GetFamilyIndex("HELVETICA"), 8, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 1 });
                        tableLayout.AddCell(new PdfPCell(new Phrase("Sub Total:", new Font(Font.GetFamilyIndex("HELVETICA"), 9, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 2 });
                        ...
                        tableLayout.AddCell(new PdfPCell(new Phrase(Convert.ToString(SumTotalAmount), new Font(Font.GetFamilyIndex("HELVETICA"), 9, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 2 });

                        tableLayout.AddCell(new PdfPCell(new Phrase(" ", new Font(Font.GetFamilyIndex("HELVETICA"), 8, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 1 });
                        tableLayout.AddCell(new PdfPCell(new Phrase(" ", new Font(Font.GetFamilyIndex("HELVETICA"), 8, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 1 });
                        tableLayout.AddCell(new PdfPCell(new Phrase("Discount:", new Font(Font.GetFamilyIndex("HELVETICA"), 9, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 2 });




                        //tableLayout.AddCell(new PdfPCell(new Phrase(Convert.ToString(SumTotalQuantity), new Font(Font.GetFamilyIndex("HELVETICA"), 8, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 1 });
                        tableLayout.AddCell(new PdfPCell(new Phrase(Convert.ToString(discount_amt), new Font(Font.GetFamilyIndex("HELVETICA"), 9, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 2 });


                        tableLayout.AddCell(new PdfPCell(new Phrase(" ", new Font(Font.GetFamilyIndex("HELVETICA"), 8, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 1 });
                        tableLayout.AddCell(new PdfPCell(new Phrase("Delivery Charge:", new Font(Font.GetFamilyIndex("HELVETICA"), 9, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 3 });




                        //tableLayout.AddCell(new PdfPCell(new Phrase(Convert.ToString(SumTotalQuantity), new Font(Font.GetFamilyIndex("HELVETICA"), 8, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 1 });
                        tableLayout.AddCell(new PdfPCell(new Phrase(Convert.ToString(delivery_charge), new Font(Font.GetFamilyIndex("HELVETICA"), 9, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 2 });


                        tableLayout.AddCell(new PdfPCell(new Phrase(" ", new Font(Font.GetFamilyIndex("HELVETICA"), 8, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 1 });
                        tableLayout.AddCell(new PdfPCell(new Phrase("Payable Amount:", new Font(Font.GetFamilyIndex("HELVETICA"), 9, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 3 });




                        //tableLayout.AddCell(new PdfPCell(new Phrase(Convert.ToString(SumTotalQuantity), new Font(Font.GetFamilyIndex("HELVETICA"), 8, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 1 });
                        tableLayout.AddCell(new PdfPCell(new Phrase(Convert.ToString(NetPayable), new Font(Font.GetFamilyIndex("HELVETICA"), 9, 1))) { Border = 0, HorizontalAlignment = Element.ALIGN_RIGHT, Colspan = 2 });



                        int amt = (int)Math.Round(NetPayable, 0);
                        string AmtInWords = Converter.NumberToWords(amt);
                        tableLayout.AddCell(new PdfPCell(new Phrase("( " + AmtInWords + " )", new Font(Font.GetFamilyIndex("HELVETICA"), 8, 0))) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 5 });
                        ...
                        tableLayout.AddCell(new PdfPCell(new Phrase("The goods sold as are intended for end user consumption and not for re-sale", new Font(Font.GetFamilyIndex("HELVETICA"), 8, 0))) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 5 });
                        tableLayout.AddCell(new PdfPCell(new Phrase("18% GST Included in delivery charges", new Font(Font.GetFamilyIndex("HELVETICA"), 8, 0))) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 5 });
                        tableLayout.AddCell(new PdfPCell(new Phrase("Goods once sold will not be taken back or exchange", new Font(Font.GetFamilyIndex("HELVETICA"), 8, 0))) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 5 });
                        
                        tableLayout.AddCell(new PdfPCell(new Phrase("A Software By: Sigma IT Softwares,Lucknow", new Font(Font.GetFamilyIndex("HELVETICA"), 9, 0))) { Border = 0, HorizontalAlignment = Element.ALIGN_LEFT, Colspan = 5 });
